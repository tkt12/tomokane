<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        try {
            ...
            header('Location:index.php'); // フォームを再送信されないようにページ更新を挟む
            exit;
...
<body>
    <div class="logo_fadein">
        <p><img src="icon/logo.png" alt="友は金なり"></p>
    </div>
    <header>
        <div class="genre">
            <ul>
                <li class="genreT"><a href="index.php">貸付</a></li>
                <li class="genreF"><a href="borrow.php">借入</a></li>
            </ul>
        <div>
    </header>
    <main>
        <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
            <input type="hidden" value="貸付" name="genre"> 
            <table class="boxTop">
                <tr class="box">
                    <th>金額</th>
                    <td>
